...
import 'Cure_Widget_detail.dart';
import 'Tool_Widget_detail.dart';
          ...
          children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Text(
                  "#한방 진료,무엇이 궁금한 곰?",
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,fontFamily: "Hangomfont_Bold"),
                ),
              ),
            ),
            Center(
                                ...
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      PageTransition(
                                          ...
                                          child: Tool_Detail_View(
                                            doc_path:
                                                search_cure_tool_list![idx]
                                                    .doc_path,
                                          )));
                                },
                                child: Container(
                              ...
                              return InkWell(
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      PageTransition(
                                          type: PageTransitionType.fade,
                                          child: Cure_Detail_View(
                                            doc_path:
                                                search_cure_disease_list![idx]
                                                    .doc_path,
                                          )));
                                },
                                child: Container(
